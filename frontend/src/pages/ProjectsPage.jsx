        ...
        <div className="page">
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent>
                  ...
                  <div style={{ display:'flex', flexDirection:'column', gap:16, marginTop:8 }}>
                    ...
                    <button onClick={createProject} style={{ padding:'10px', background:'#059669', color:'#fff', border:'none', borderRadius:8, fontSize:14, fontWeight:600, cursor:'pointer', marginTop:4 }}>
                      Create Project
                    </button>
                  </div>
                </DialogContent>
          ...
          {projects.length === 0 ? (
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:16 }}>
              {projects.map(p => (
                <div key={p.id} className={`project-card ${statusClass[p.status]||''}`} onClick={()=>navigate(`/projects/${p.id}`)}>
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:10 }}>
                    <h3 style={{ margin:0, fontSize:15, fontWeight:600, color:'var(--foreground)', letterSpacing:'-0.2px' }}>{p.name}</h3>
                  ...
                  {(p.start_date || p.end_date) && (
                    <div style={{ fontSize:12, color:'var(--muted-foreground)', marginTop:8, display:'flex', alignItems:'center', gap:4 }}>
